      ...
      <div id="content">
        ...
        <div class="container-fluid py-4">
          <div class="d-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Manager Dashboard</h1>
          ...
          <div class="row">
            <div class="col-lg-4 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Task dang xu ly</div>
            ...
            <div class="col-lg-4 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Du an dang theo doi</div>
          ...
          <div class="row">
            <div class="col-lg-6 mb-4">
              <div class="card shadow">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-success">Duyet don nhan vien</h6>
                </div>
                <div class="card-body">
                  <p class="text-muted mb-3">Xu ly don xin nghi, cong tac, phep.</p>
            ...
            <div class="col-lg-6 mb-4">
              <div class="card shadow">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Quan ly cong viec</h6>
                </div>
                <div class="card-body">
                  <p class="text-muted mb-3">Theo doi task qua Kanban va Gantt.</p>
                  <a href="tasks.php" class="btn btn-primary btn-sm">Mo Task Hub</a>
                </div>
              </div>
            </div>
          </div>

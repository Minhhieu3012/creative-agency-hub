...
return [
    ...
    ['POST',   '/api/employees/:id/adjust-leave', EmployeeController::class, 'adjustLeave',  ['admin', 'manager']],
    ['POST',   '/api/employees/:id/avatar',       EmployeeController::class, 'uploadAvatar', ['admin', 'manager', 'employee']],

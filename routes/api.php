...
return [
    ...
    // CLIENT PORTAL (KHÁCH HÀNG THEO DÕI DỰ ÁN)
    ['GET', '/api/client/projects',           'ClientPortal\\ClientProjectController@index', ['client']],
    ['GET', '/api/client/projects/:id',       'ClientPortal\\ClientProjectController@show', ['client']],
    ['GET', '/api/client/projects/:id/tasks', 'ClientPortal\\ClientProjectController@tasks', ['client']],

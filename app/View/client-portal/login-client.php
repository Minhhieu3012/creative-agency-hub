...
<section class="client-login-wrapper">
  <div class="client-login-card">
    <section class="client-login-form">
      <a href="<?php echo $baseUrl; ?>/app/View/client-portal/login-client.php" class="client-login-brand">
      ...
      <form method="POST" action="<?php echo $baseUrl; ?>/public/api/client/login" data-ui-form data-mock-submit="true"
        data-success-message="Đăng nhập Client Portal thành công." data-redirect="<?php echo $baseUrl; ?>/app/View/client-portal/projects.php">
        <div class="form-group">
          <label class="form-label" for="client_email">Địa chỉ Email</label>
          <div class="input-with-icon">
            <span class="input-icon">✉</span>
            <input id="client_email" class="form-control" type="email" name="email" placeholder="client@company.com"
        ...
        <div class="form-group">
          ...
          <div class="input-with-icon">
            <span class="input-icon">▣</span>
            <input id="client_password" class="form-control" type="password" name="password" placeholder="••••••••"
              autocomplete="current-password" required>

            <button type="button" class="password-eye" data-password-toggle="#client_password"
    ...
    <aside class="client-login-visual">
      <img class="client-login-visual-image" src="<?php echo $baseUrl; ?>/public/assets/pictures/customerpagelogin.jpg"

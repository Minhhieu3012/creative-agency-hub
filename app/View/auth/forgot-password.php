...
// Xác định cổng truy cập từ URL parameter để điều hướng quay lại chính xác
$portal = $_GET['portal'] ?? 'client';
$backLink = ($portal === 'internal') 
            ? (APP_URL . '/login') 
            : (APP_URL . '/client-portal/login-client');
...
<section class="client-login-wrapper">
    <div class="client-login-card client-single-card">
        ...
        <section class="client-login-form form-reset-padding">
            ...
            <a href="<?php echo $backLink; ?>" class="client-login-brand">
            ...
            <p class="auth-footer-line" style="margin-top: 24px; margin-bottom: 0;">
                Nhớ ra mật khẩu? <a href="<?php echo $backLink; ?>">Quay lại đăng nhập</a>
            </p>
        </section>
    </div>
</section>
